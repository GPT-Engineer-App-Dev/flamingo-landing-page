    ...
    <div className="flex min-h-screen w-full flex-col">
      <header className="sticky top-0 flex h-16 items-center gap-4 border-b bg-background px-4 md:px-6 justify-between">
        <nav className="hidden flex-col gap-6 text-lg font-medium md:flex md:flex-row md:items-center md:gap-5 md:text-sm lg:gap-6">
          ...
          <a href="#habitat" className="text-muted-foreground transition-colors hover:text-foreground">Habitat</a>
          <a href="#gallery" className="text-muted-foreground transition-colors hover:text-foreground">Gallery</a>
        ...
        <Sheet>
          ...
          <SheetContent side="left">
            <nav className="grid gap-6 text-lg font-medium">
              ...
              <a href="#habitat" className="text-muted-foreground hover:text-foreground">Habitat</a>
